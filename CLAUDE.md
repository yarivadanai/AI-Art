...
npx tsx scripts/run_cohort.ts --cohort reference   # seat the reference solver (DB-direct, no server); --cohort llm --model <id> seats a language model (needs ANTHROPIC_API_KEY)
```
